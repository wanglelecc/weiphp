...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://wechat02.56br.com/index.php?s=/w16/QrAdmin/QrAdmin/add.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-action_name '>
			<label class='item-label'><span class='need_flag'>*</span>类型<span class='check-tips'>(临时二维码最长有效期是30天)</span></label>
			<div class='controls'><select name='action_name'><option value='QR_SCENE' class='toggle-data' toggle-data='' selected >临时二维码</option><option value='QR_LIMIT_SCENE' class='toggle-data' toggle-data=''>永久二维码</option></select></div></div>
<div class='form-item cf toggle-group_id '>
			<label class='item-label'>用户组</label>
			<div class='controls'><div id='dynamic_select_group_id'></div><?php echo hook ( 'dynamic_select', ['name' => 'group_id', 'value' => '', 'extra' => 'table=auth_group&value_field=id&title_field=title&first_option=不选择'] );?></div></div>
<div class='form-item cf toggle-tag_ids '>
			<label class='item-label'>用户标签</label>
			<div class='controls'><div id='dynamic_checkbox_tag_ids'></div><?php echo hook ( 'dynamic_checkbox', ['name' => 'tag_ids', 'value' => '', 'extra' => 'table=user_tag'] );?></div></div>
<div class='form-item cf toggle-material '>
			<label class='item-label'>扫码后的回复内容</label>
			<div class='controls'><div id='material_material'></div><?php echo hook ( 'material', ['name' => 'material', 'value' => '', 'extra' => ''] );?></div></div>
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1503360889' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1503360889' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1503360889' charset='UTF-8'></script> 
  <script type='text/javascript'>
