...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://wechat02.56br.com/index.php?s=/w16/Cms/Cms/add.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-title '>
...
<div class='form-item cf toggle-img '>
			...
			<div class='controls'><div class='controls uploadrow2' data-max='1' title='点击修改图片' rel='img'>
...
<div class='form-item cf toggle-content '>
			<label class='item-label'>正文内容</label>
			<div class='controls'><label class='textarea input-large'><textarea name='content'></textarea></label></div></div>
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1503362521' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1503362521' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1503362521' charset='UTF-8'></script> 
  <script type='text/javascript'>
