...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <div class="tab-content"> 
        <!-- 表单 -->
        <form id="form" action="<?php echo U('add_custom_tag');?>" method="post" class="form-horizontal form-center">
          <ul id="tab" class="tab-pane in">
            <li class="form-item cf toggle-pre">
              <label class="item-label">用户组 <!--<a href="">增加新标签</a>--></label>
              <div class="controls">
                <select name="tag_id" >
                  <option value="0">不限</option>
                  <?php if(!empty($tags)): if(is_array($tags)): $i = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                </select>
              </div>
            </li>
            <li class="form-item cf toggle-pre">
              ...
              <div class="controls">
                <div class="check-item">
                  <input type="radio" class="regular-radio toggle-data" value="0" id="no_sex" name="sex" checked/>
                  <label for="no_sex"></label>
                  不限 </div>
                <div class="check-item">
                  <input type="radio" class="regular-radio toggle-data" value="1" id="man" name="sex"/>
                  <label for="man"></label>
                  男 </div>
                <div class="check-item">
                  <input type="radio" class="regular-radio toggle-data" value="2" id="woman" name="sex"/>
                  <label for="woman"></label>
                  女 </div>
              </div>
            </li>
            <li class="form-item cf toggle-pre">
              <label class="item-label">手机操作系统 </label>
              <div class="controls">
                <div class="check-item">
                  <input type="radio" class="regular-radio toggle-data" value="0" id="no_phone" name="os" checked/>
                  <label for="no_phone"></label>
                  不限 </div>
                <div class="check-item">
                  <input type="radio" class="regular-radio toggle-data" value="1" id="ios" name="os"/>
                  <label for="ios"></label>
                  IOS </div>
                <div class="check-item">
                  <input type="radio" class="regular-radio toggle-data" value="2" id="android" name="os"/>
                  <label for="android"></label>
                  Android </div>
                <div class="check-item">
                  <input type="radio" class="regular-radio toggle-data" value="3" id="other" name="os"/>
            ...
            <li class="form-item cf toggle-pre">
              ...
              <div class="controls"> 
                ...
                <div id="cascade_area"></div>
                <?php echo hook('cascade', array('name'=>'area','value'=>'','extra'=>'table=area&first_option=不限'));?>
            ...
            <li class="form-item cf toggle-pre">
              ...
              <div class="controls">
                <select name="lang">
                  <option value="0">不限</option>
                    <?php if(!empty($lang)): if(is_array($lang)): $i = 0; $__LIST__ = $lang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; endif; ?>               
                </select>
              </div>
            </li>
          </ul>
          <div class="form-item form_bh">
            <input type="hidden" name="rule_ie" value="<?php echo I('rule_id', 0);?>" />
