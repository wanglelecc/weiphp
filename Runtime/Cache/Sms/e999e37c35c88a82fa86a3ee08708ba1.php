				...
				<div class="form-item cf">
					<label class="item-label">
						短信服务商
							...
							<div class="controls">
								<select name="config[type]" class='selectType'>
										<option value="1" <?php if($data["config"]["type"]["value"] == 1): ?>selected = "selected"<?php endif; ?> >云之讯</option>
										<option value="2" <?php if($data["config"]["type"]["value"] == 2): ?>selected = "selected"<?php endif; ?> >腾讯云</option>
								</select>
							</div>
							<div class='type1'>
					<label class="item-label" >
						开发者Account Sid
							...
							<div class="controls">
								<input type="text" name="config[accountSid]" class="text input-large" value="<?php echo ($data["config"]["accountSid"]["value"]); ?>">
							</div>
						...
						开发者Auth Token
							...
							<div class="controls">
								<input type="text" name="config[authToken]" class="text input-large" value="<?php echo ($data["config"]["authToken"]["value"]); ?>">
							</div>
							<label class="item-label">
						应用Id
							<span class="check-tips">在服务商平台上应用里面创建获得</span>
					</label>
							<div class="controls">
								<input type="text" name="config[appId]" class="text input-large" value="<?php echo ($data["config"]["authToken"]["value"]); ?>">
							</div>
							<label class="item-label">
						会员卡手机认证短信模板Id
							<span class="check-tips">模板格式：您的验证码是{1},请于10分钟内输入正确的验证码</span>
					</label>
							<div class="controls">
								<input type="text" name="config[TemplateId]" class="text input-large" value="<?php echo ($data["config"]["TemplateId"]["value"]); ?>">
							</div>
							</div>
							<div class='type2'>
							<label class="item-label">
						腾讯云appid
							...
							<div class="controls">
								<input type="text" name="config[appid]" class="text input-large" value="<?php echo ($data["config"]["appid"]["value"]); ?>">
							</div>
							<label class="item-label">
						腾讯云appkey
					</label>
							<div class="controls">
								<input type="text" name="config[appkey]" class="text input-large" value="<?php echo ($data["config"]["appkey"]["value"]); ?>">
							</div>
							<label class="item-label">
						短信签名
					</label>
							<div class="controls">
								<input type="text" name="config[sign]" class="text input-large" value="<?php echo ($data["config"]["sign"]["value"]); ?>">
							</div>
							<label class="item-label">
						短信模板Id
							<span class="check-tips">模板格式：您的验证码是${code},请于10分钟内输入正确的验证码</span>
					</label>
							<div class="controls">
								<input type="text" name="config[TtemplateId]" class="text input-large" value="<?php echo ($data["config"]["TtemplateId"]["value"]); ?>">
							</div>
						</div>	
...
var type ="<?php echo ($data["config"]["type"]["value"]); ?>";
if(type == 2){
	$('.type1').hide();
}else{
	$('.type2').hide();
