...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <form action="<?php echo U ( 'lists',array('is_down'=>1) );?>" id="form_search">
      <div class="table-bar">
        <div class="fl">
...
<!--           <a href="<?php echo U ( 'Home/AuthGroup/export' );?>" class="btn">导出用户</a> &nbsp;  -->
        ...
        <div class="search-form fr cf">
          ...
          <div class="sleft">
			<input type="hidden" name="group_id" value="<?php echo I('group_id',0);?>" />
