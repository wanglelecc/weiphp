  ...
  <div class="span9 page_message">
    <section id="contents"> 
      ...
      <div class="table-bar">
        <div class="fl">
			<div class="tools">
				<?php if($add_button): $add_url || $add_url = U('add?model='.$model['id'],array('mdm'=>$_GET['mdm'])); ?><a class="btn" href="<?php echo ($add_url); ?>">新 增</a><?php endif; ?>
				<?php if($del_button): $del_url || $del_url = U('del?model='.$model['id'],array('mdm'=>$_GET['mdm'])); ?><button class="btn ajax-post confirm" target-form="ids" url="<?php echo ($del_url); ?>">删 除</button><?php endif; ?>                
			</div>
        </div>
        <!-- 高级搜索 -->
