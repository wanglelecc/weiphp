    ...
    <section id="contents"> 
      <div class="setting_step app_setting content_step" style="margin-top:20px;">
         <a class="step " href="<?php echo addons_url('WeiSite://Template/lists',array('mdm'=>I('mdm')));?>">1.选择列表模板</a>
       	 <a class="step step_cur" href="<?php echo addons_url('WeiSite://Template/detail',array('mdm'=>I('mdm')));?>">2.选择内容模板</a>
         <a class="step step_cur_1" href="<?php echo addons_url('WeiSite://Cms/lists',array('mdm'=>I('mdm')));?>">3.内容管理</a> 
      ...
      <?php if($add_button || $del_button || $search_button || !empty($top_more_button)): ?><div class="table-bar">
        ...
        <?php if($search_button): ?><div class="search-form fr cf">
          <div class="sleft">
            ...
            <input type="text" name="<?php echo ($search_key); ?>" class="search-input" value="<?php echo I($search_key);?>" placeholder="请输入标题">
