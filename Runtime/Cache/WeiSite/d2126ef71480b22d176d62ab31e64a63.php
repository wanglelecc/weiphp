    ...
    <section id="contents"> 
       <div class="setting_step app_setting content_step" style="margin:20px">
         <a class="step " href="<?php echo addons_url('WeiSite://Template/index',array('mdm'=>I('mdm')));?>">1.选择模板</a>
       	 <a class="step step_cur" href="<?php echo addons_url('WeiSite://Slideshow/lists',array('mdm'=>I('mdm')));?>">2.幻灯片配置</a>
         <a class="step step_cur_1" href="<?php echo addons_url('WeiSite://Category/lists',array('mdm'=>I('mdm')));?>">3.栏目配置</a> 
         <a class="step " href="<?php echo addons_url('WeiSite://WeiSite/preview',array('mdm'=>I('mdm')));?>">4.效果预览</a>
  </div>
      <?php if($no_slideshow): ?><p style="padding:80px 30px 30px; text-align:center; font-size:18px">您选择的模板不需要配置幻灯片!</p>
      <p style="padding:30px; text-align:center"><a class="btn submit-btn" href="<?php echo addons_url('WeiSite://Category/lists');?>">下一步</a></p>
      <?php else: ?>
      <div class="table-bar">
        <div class="fl">
			<div class="tools">
