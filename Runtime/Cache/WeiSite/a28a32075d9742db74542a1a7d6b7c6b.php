  ...
  <div class="span9 page_message">
    <section id="contents"> 
      <div class="setting_step app_setting content_step" style="margin:20px">
         <a class="step step_cur" href="<?php echo addons_url('WeiSite://Template/index',array('mdm'=>I('mdm')));?>">1.选择模板</a>
       	 <a class="step step_cur_1" href="<?php echo addons_url('WeiSite://Slideshow/lists',array('mdm'=>I('mdm')));?>">2.幻灯片配置</a>
      ...
      <?php if(!$has_slide): ?><p style="padding:80px 30px 30px; text-align:center; font-size:18px">您选择的模板不需要配置幻灯片!
        </p>
