...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://wechat02.56br.com/index.php?s=/w16/Servicer/Servicer/add.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-uid '>
			<label class='item-label'><span class='need_flag'>*</span>用户选择</label>
			<div class='controls'><div id='userList' class='common_add_list fl'><a href='javascript:
					;' class='common_add_btn fl' onClick='$.WeiPHP.selectSingleUser("http://wechat02.56br.com/index.php?s=/w16/UserCenter/UserCenter/lists.html","uid");'></a> </div></div></div>
<div class='form-item cf toggle-truename '>
			<label class='item-label'><span class='need_flag'>*</span>真实姓名</label>
			<div class='controls'><input type='text' class='text input-large' name='truename' value=''></div></div>
<div class='form-item cf toggle-mobile '>
			<label class='item-label'><span class='need_flag'>*</span>手机号</label>
			<div class='controls'><input type='text' class='text input-large' name='mobile' value=''></div></div>
<div class='form-item cf toggle-role '>
			<label class='item-label'>授权列表</label>
			<div class='controls'><div class='check-item'>
						<input type='checkbox' class='regular-checkbox toggle-data' value='2' id='role_2' name='role[]' toggle-data='' checked='checked' />
							<label for='role_2'></label>扫码验证</div></div></div>
<div class='form-item cf toggle-enable '>
			<label class='item-label'>是否启用</label>
			<div class='controls'><div class='check-item'>
						<input type='radio' class='regular-radio toggle-data' value='0' id='enable_0' name='enable' toggle-data=''/>
							<label for='enable_0'></label>禁用</div><div class='check-item'>
						<input type='radio' class='regular-radio toggle-data' value='1' id='enable_1' name='enable' toggle-data='' checked='checked' />
							<label for='enable_1'></label>启用</div></div></div>
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1503362004' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1503362004' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1503362004' charset='UTF-8'></script> 
  <script type='text/javascript'>
