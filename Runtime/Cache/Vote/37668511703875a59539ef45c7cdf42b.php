...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://wechat02.56br.com/index.php?s=/w16/Vote/ShopVote/add.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-title '>
			<label class='item-label'>活动名称</label>
			<div class='controls'><input type='text' class='text input-large' name='title' value=''></div></div>
<div class='form-item cf toggle-select_type '>
			<label class='item-label'>投票类型</label>
			<div class='controls'><div class='check-item'>
						<input type='radio' class='regular-radio toggle-data' value='1' id='select_type_1' name='select_type' toggle-data='multi_num@hide' checked='checked' />
							<label for='select_type_1'></label>单选</div><div class='check-item'>
						<input type='radio' class='regular-radio toggle-data' value='2' id='select_type_2' name='select_type' toggle-data='multi_num@show'/>
							<label for='select_type_2'></label>多选</div></div></div>
<div class='form-item cf toggle-multi_num '>
			<label class='item-label'>多选限制<span class='check-tips'>(0代表不限制)</span></label>
			<div class='controls'><input type='number' class='text' name='multi_num' value=''></div></div>
<div class='form-item cf toggle-start_time '>
			<label class='item-label'>开始时间</label>
			<div class='controls'><input type='datetime' name='start_time' class='text time' value='' placeholder='请选择时间' /></div></div>
<div class='form-item cf toggle-end_time '>
			<label class='item-label'>结束时间</label>
			<div class='controls'><input type='datetime' name='end_time' class='text time' value='' placeholder='请选择时间' /></div></div>
<div class='form-item cf toggle-remark '>
			<label class='item-label'>活动说明</label>
			<div class='controls'><label class='textarea input-large'><textarea name='remark'></textarea></label></div></div>
<div class='form-item cf toggle-is_verify '>
			<label class='item-label'>投票是否需要填写验证码<span class='check-tips'>(防止刷票行为时需要开启)</span></label>
			<div class='controls'><select name='is_verify'><option value='0' class='toggle-data' toggle-data='' selected >不需要</option><option value='1' class='toggle-data' toggle-data=''>需要</option></select></div></div>
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1503362095' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1503362095' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1503362095' charset='UTF-8'></script> 
  <script type='text/javascript'>
