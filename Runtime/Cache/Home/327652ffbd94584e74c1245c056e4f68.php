...
<div id="main-container" class="container" style="position:relative">
  ...
  <div class="setting_step app_setting">
         <a class="step step_cur_1" href="<?php echo U('Home/Apps/step_0',['id' => $id ]);?>">1.增加基本信息</a>
         <!-- <a class="step " href="<?php if(empty($id)): ?>javascript:;<?php else: ?> <?php echo U('Home/Apps/step_1',['id' => $id ]); endif; ?>">2.配置公众平台</a>
         <a class="step " href="<?php if(empty($id)): ?>javascript:;<?php else: ?> <?php echo U('Home/Apps/step_2',['id' => $id ]); endif; ?>">3.保存接口配置</a> 
         -->
  ...
  <div class="tab-content"> 
    <!-- 表单 -->
    <form class="form-horizontal bind_step_form" method="post" action="<?php echo U('Home/Apps/step_0');?>" id="form" style="overflow:hidden; zoom:1">
      <!-- 基础文档模型 -->
      <div class="tab-pane in tab1" id="tab1">
        <div class="item_wrap">
          ...
          <label class="item-label"> <span class="need_flag">*</span> 公众号名称 </label>
          <div class="controls">
