...
background-color: #eaeaea;">
           <div class="msg_tab">
            ...
            <?php $post_url || $post_url = U('custom_sendall?model='.$model['id'], $get_param); ?>
                ...
                <label class="textarea" style="position:relative; overflow:hidden; zoom:1;">
                    ...
                    <div style="display:none;margin:0 10px 10px 0; background:#ddd; padding:6px;height:204px; width:930px;float:left" class="msg_image controls">
                        ...
                        <div class='image_material' id='image_material'>
                            ...
                            <a class="select_image" href="javascript:;"  onClick="$.WeiPHP.openSelectAppMsg('<?php echo U('Home/Material/picture_data');?>',selectImageCallback)">从素材库选择图片</a>
                 ...
                 <div class="form-item cf toggle-send_type">
                    <label class="item-label"> 发送方式 </label>
                    <div class="controls">
...
function selectUser(){
	$.WeiPHP.openSelectUsers("<?php echo addons_url('UserCenter://UserCenter/lists');?>",0,function(data){
		if(data && data.length>0){
