...
<section id="contents">
  <div class="tab-content" style="margin:30px auto;"> 
    ...
    <!-- 表单 -->
    <form class="form-horizontal bind_step_form" method="post" action="<?php echo U('Home/Apps/add', array('from'=>7));?>" id="form" style="overflow:hidden; zoom:1">
      <!-- 基础文档模型 -->
      <div class="tab-pane in tab1" id="tab1">
        ...
        <div class="form-item cf toggle-GammaSecret">
          ...
          <div class="form-item cf toggle-tongji_code">
            <label class="item-label"> 第三方统计代码 </label>
            <div class="controls">
...
<!--          <div class="form-item cf toggle-tips_url" style="display:none">
            <label class="item-label">提示关注公众号的文章地址 </label>
            <div class="controls">
