  ...
  <div class="wrap">
    <section id="contents">
      <div class="setting_step app_setting">
             <a class="step step_cur" href="<?php echo U('Home/Apps/step_0',['id' => $id ]);?>">1.增加基本信息</a>
             <a class="step step_cur_1" href="<?php echo U('Home/Apps/step_1',['id' => $id ]);?>">2.配置公众平台</a>
             <a class="step " href="<?php echo U('Home/Apps/step_2',['id' => $id ]);?>">3.保存接口配置</a>
      </div>   
      <div class="tab-content bind_step_form"> 
              ...
              <?php if(C('DIV_DOMAIN')) { echo U('home/weixin/index'); }else { echo U('home/weixin/index',['id' => $id ]); } ?></span><br>
              ...
              <div class="bind_step_form_next_item">
              	<a class="btn submit-btn" href="<?php echo U('Home/Apps/step_2',['id' => $id ]);?>">下一步</a>
             	<br/>
