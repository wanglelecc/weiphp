        ...
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                ...
                <a href="<?php echo U('edit',array('id'=>$data[id],'mdm'=>$_GET['mdm']));?>" target="_self">编辑</a>&nbsp;&nbsp;&nbsp;
                <a href="<?php echo addons_url('Reserve://ReserveValue/lists',array('reserve_id'=>$data[id],'mdm'=>$_GET['mdm']));?>" >预约列表</a>&nbsp;&nbsp;&nbsp;
