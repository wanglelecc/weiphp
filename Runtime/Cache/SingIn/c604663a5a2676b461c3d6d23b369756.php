  ...
  <div class="span9 page_message">
    <section id="contents">
      <ul class="tab-nav nav">
        <li class="current"><a href="<?php echo U('lists');?>">签到记录</a></li>
        <li><a href="<?php echo U('config');?>">签到配置</a></li>
      </ul>
      ...
      <div class="table-bar">
        ...
        <div class="search-form fr cf">
          <div class="sleft">
            <input type="text" name="<?php echo ((isset($model['search_key']) && ($model['search_key'] !== ""))?($model['search_key']):'uid'); ?>" class="search-input" value="<?php echo I('uid');?>" placeholder="请输入关键字">
          ...
          <table cellpadding="0" cellspacing="1">
            ...
            <tbody>
              <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo (date("y-m-d H:i:s",$data["sTime"])); ?></td>
