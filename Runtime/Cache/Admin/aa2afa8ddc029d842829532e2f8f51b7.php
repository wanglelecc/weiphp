  ...
  <div id="main" class="main">
	...
	<div class="cf">
		<div class="fl tools">
				...
				<a class="btn" href="<?php echo U('Api/Index/index');?>" target='_blank'>API说明手册</a>
		</div>
		<!-- 高级搜索 -->
    ...
    <!-- 数据列表 -->
      <?php $now_by = I('by','asc'); if($now_by=='asc'){ $next_by = 'desc'; $by_icon = '（正序）'; } else { $next_by = 'asc'; $by_icon = '（倒序）'; } ?>
