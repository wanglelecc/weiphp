  ...
  <div id="main" class="main">
    ...
    <div class="main-title">
        ...
        <div class="weui-cell-cp">
          ...
          <label for="switch_2" class="weui-switch-cp">
              <input id="switch_2" class="weui-switch-cp__input" type="checkbox" <?php if(!empty($request_log)): ?>checked="checked"<?php endif; ?> >
	...
	<div class="cf">
        ...
        <?php if($search_button): ?><div class="search-form fr cf">
			<div class="sleft">
                <?php $search_url || $search_url = U('Think/lists','model='.$model['name'],false); ?>
