...
function register_administrator($db, $prefix, $admin, $auth){
	...
	$sql = "INSERT INTO `[PREFIX]user` (`uid`, `nickname`, `password`, `email`, `mobile`, `reg_time`, `reg_ip`, `last_login_time`, `last_login_ip`, `status`,`is_init`,`is_audit`) VALUES " .
		   "('1', '[NAME]', '[PASS]', '[EMAIL]', '', '[TIME]', '[IP]', 0, 0, '1',1,1)";
