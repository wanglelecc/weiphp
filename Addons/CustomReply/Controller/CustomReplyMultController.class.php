...
class CustomReplyMultController extends BaseController {
	...
	public function add() {
		...
		$this->display ( T ( 'Addons://' . MODULE_NAME . '@' . CONTROLLER_NAME . '/add' ) );
	}
